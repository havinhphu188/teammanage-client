...
function (_React$Component) {
  ...
  function AssignMemberDialog(props) {
    var _this;

    _classCallCheck(this, AssignMemberDialog);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(AssignMemberDialog).call(this, props));
    _this.state = {
      loading: true
    };
    return _this;
...
//# sourceMappingURL=project-board.js.b6bec432590cc0babace.hot-update.js.map